...
```json
{
  "name": "Minecraft 5.1.2", // unique name (check if it has been used already in the file)
  ...
  "data": {
    ...
    "url": "https://sd592g.github.io/zj684od4lfg/", // url of the app and make sure they accept Iframe
    "gallery": [
    ...
    "desc": "Minecraft is a sandbox construction video game ... but V5.1.2", // description for store app
